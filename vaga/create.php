                            ...
                            <div class="card-body font-weight-bold card-vaga-content">
                                ...
                                <div class="form-group card-vaga-content">
                                    <div>
                                        ...
                                        <input type="text" name="nome" placeholder="Informe o cargo" size="80" required autofocus>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="carga_horaria" placeholder="Informe a carga horária." required>
                                    </div>
                                    <div>
                                        <label for="data_publicacao">Data de Publicação: </label>
                                        <input type="date" name="data_publicacao" placeholder="Informe a data de publicacao." required>
                                    </div>
                                    <div>
                                        <label style for="data_expiracao">Data de Expiração: </label>
                                        <input type="date" name="data_expiracao" placeholder="Informe a data de publicacao." required>
                                    </div>
