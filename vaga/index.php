    ...
    <?php } else if (isset($_GET['msg']) && $_GET['msg'] == 'erro') { ?>
        ...
        <div class="card-vaga">
            ...
            <section class="section__btn">
                ...
                <a class="btn" href="../usuarios/administrador/index.php">Consultar vagas</a>
            </section>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="td__operacao">
                                                            <a class="btnalterar" href="edit.php?id=<?= $vaga['id']; ?>">Alterar</a>
                                                            <a class="btnexcluir" href="delete.php?id=<?= $vaga['id']; ?>" onclick="return confirm('Deseja confirmar a operação?');">Excluir</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
